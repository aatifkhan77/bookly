            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <?php
                            $query = mysqli_query($conn, "select sno from candidate_detail");
                            $totalusers = mysqli_num_rows($query);
                            ?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total Applied Candidates
                            ...
                            <?php
                            $query1 = mysqli_query($conn, "select sno from candidate_detail where date(date_time)=CURRENT_DATE()-1");
                            $yesterdayregusers = mysqli_num_rows($query1);
                            ?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Yesterday Registered Candidates
                            ...
                            <?php
                            $query2 = mysqli_query($conn, "select sno from candidate_detail where date(date_time)>=now() - INTERVAL 7 day");
                            $last7daysregusers = mysqli_num_rows($query2);
                            ?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body"> Applied Candidates Profiles in Last 7 Days
                            ...
                            <?php
                            $query3 = mysqli_query($conn, "select sno from candidate_detail where date(date_time)>=now() - INTERVAL 30 day");
                            $last30daysregusers = mysqli_num_rows($query3);
                            ?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Applied Candidates Profiles in Last 30 Days
