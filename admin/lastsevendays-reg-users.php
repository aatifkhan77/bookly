...
if (strlen($_SESSION['adminid'] == 0)) {
    ...
    if (isset($_GET['id'])) {
        $adminid = $_GET['id'];
        $msg = mysqli_query($conn, "delete from candidate_detail where user_id='$adminid'");
        $msg1 = mysqli_query($conn, "delete from candidate_details where user_id='$adminid'");
        if ($msg) {
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php $ret = mysqli_query($conn, "select * from candidate_detail where date(date_time)>=now() - INTERVAL 7 day");
                                        $cnt = 1;
